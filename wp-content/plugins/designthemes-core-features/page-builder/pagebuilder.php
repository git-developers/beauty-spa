	...
	class DTPageBuilder {
		...
		function dt_add_custom_metabox(){
			...
			foreach ( $post_types as $post_type ){
				add_meta_box( 'dtthemes-metabox', $theme_name.esc_html__( ' Page Builder', 'dt_plugins' ), array ($this, 'dtthemes_custom_metabox_layout'), $post_type, 'normal', 'high', array( 'id' => $ptid) );
			}
		...
		function dt_disable_builder_option(){
			...
			echo '<div class="dt_builder_option">'
					. esc_html__( 'Enable page builder', 'dt_plugins' ) .' <div data-for="dtthemes-enable-builder" id="dt_enable_builder" class="chkbx-switch '.$switch_cls.'"></div>' 
