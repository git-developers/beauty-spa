...
<div id="dtthemes_save">
    <span id="dtthemes_clear_all_wrapper">
        <span id="dtthemes_clear_all" class="dt_button dtthemes_clearall"><?php echo esc_html__('Clear All', 'dt_plugins'); ?></span>
    </span>
    <span id="dtthemes_create_layout_wrapper">
        <span id="dtthemes_create_layout" class="dt_button dtthemes_createlayout"><?php echo esc_html__('Create Sample Layout', 'dt_plugins'); ?></span>
    </span>
    <div class="dt_button">
        <span id="dt_add_customcss" class="dt_customcss_icon"></span>
        <span id="dt_add_customcss" class="dt_customcss_text"><?php echo esc_html__('Add Custom CSS', 'dt_plugins'); ?></span>
    </div>
</div>
    ...
    <div id="dt_dragdrop_container">
        ...
        <div id="dt_layout_container">
            ...
            <div class="dtthemes_modules_initiator">
            	<div class="dt_show_modules_in_popup dt_popup_from_layout"><?php esc_html_e('Add Modules', 'dt_plugins'); ?></div>
                <div class="dt_show_modules_in_popup dt_samplelayout_popup_from_layout"><?php esc_html_e('Add Sample Layouts', 'dt_plugins'); ?></div>
            </div>
        </div>
...
<div id="dtthemes_ajax_save">
	<span><?php esc_html_e( 'Saving...', 'dt_plugins' ); ?></span>
</div>