...
if ( ! function_exists('dt_get_modules_menu') ){
	function dt_get_modules_menu($dt_hide_elements){
		...
		if(isset($dtthemes_columns) && (!in_array('columns', $dt_hide_elements))) { ?><a href="#" class="dt_add_element dt_add_column"><?php esc_html_e('Columns', 'dt_plugins'); ?></a><?php }
		...
		if(isset($dtthemes_sample_layouts) && (!in_array('samplelayout', $dt_hide_elements))) { ?><a href="#" class="dt_add_element dt_add_sample_layout"><?php esc_html_e('Sample Layouts', 'dt_plugins'); ?></a><?php }
			...
			foreach ( $dtthemes_columns as $column_key => $column_settings ){
				...
				if($column_settings['type'] != 'section') {
					...
					echo "<div data-placeholder='" . esc_attr( $column_settings['name'] ) . "' data-filter='" . esc_attr( strtolower($column_settings['name']) ) . "' data-name='" . esc_attr( $column_key ) . "' class='" . esc_attr( "dt_module dt_m_column {$extra_cls} dt_m_column_{$column_key}" ) . "'>" .
						...
						<div class="dt_show_modules_in_popup dt_popup_from_column" title="'.esc_attr__('Add Module', 'dt_plugins').'"></div>
					</div>';
					...
					echo "<div data-placeholder='" . esc_attr( $column_settings['name'] ) . "' data-filter='" . esc_attr( strtolower($column_settings['name']) ) . "' data-name='".$column_key."' class='" . esc_attr( "dt_module dt_disable_resize dt_fullwidth_section {$column_key}" ) . "'>" .
						...
						<div class="dt_show_modules_in_popup dt_popup_from_section" title="'.esc_attr__('Add Module', 'dt_plugins').'"></div>
					</div>';
...
if ( ! function_exists('dt_generate_module_options') ){
	function dt_generate_module_options( $module_name, $dt_module_exact_name, $module_type ){
		...
		echo '<div class="dt_dialog_handle">' . esc_html( $dt_module_exact_name . ' ' . esc_html__('Settings', 'dt_plugins') ) . '</div><a href="#" id="dt_close_module_settings"></a>';
				...
				switch ( $option_settings['type'] ) {
					...
					case 'select':		
						...
						'<span class="selection-box"><select name="' . esc_attr( $option_slug ) . '" id="' . esc_attr( $option_slug ) . '" class="dtthemes_option ' . $dt_depand . ' ' . $content_class . '" '.$multi_str.'>'
							. '<option value="'.$select_value.'">  ' . esc_html__('Select', 'dt_plugins') . '  </option>';
					...
					case 'upload':
						echo '<input name="' . esc_attr( $option_slug ) . '" type="text" id="' . esc_attr( $option_slug ) . '" value="" class="regular-text dtthemes_option dtthemes_upload_field' . $content_class . '" />' . '<a href="#" class="dtthemes_upload_button">' . esc_html__('Upload', 'dt_plugins') . '</a>';
						break;
		...
		echo '<span id="dt_save_data" class="dt_button dt_save_text">'.esc_html__('Save Changes', 'dt_plugins').'</span>';
...
if ( ! function_exists('dt_generate_widget_options') ){
	function dt_generate_widget_options( $module_name, $dt_module_exact_name ){
		...
		if(isset($dt_widgets[$module_name]['form'])):
			...
			echo '<div class="dt_dialog_handle">' . esc_html( $dt_module_exact_name . ' ' . esc_html__('Settings', 'dt_plugins') ) . '</div><a href="#" id="dt_close_widget_settings"></a>';
...
if ( ! function_exists('dt_generate_columnoptions_panel') ){
	function dt_generate_columnoptions_panel($dt_module_name ){
		...
		echo '<div class="dt_dialog_handle">' . esc_html__('Column Options', 'dt_plugins') . '</div><a href="#" id="dt_close_column_settings"></a>';
				...
				switch ( $option_settings['type'] ) {
					...
					case 'select':		
						...
						'<span class="selection-box"><select name="' . esc_attr( $option_slug ) . '" id="' . esc_attr( $option_slug ) . '" class="dtthemes_option dt_multiselect" '.$multi_str.'>'
							. '<option value="">  ' . esc_html__('Select', 'dt_plugins') . '  </option>';
							foreach ( $option_settings['options'] as  $setting_key => $setting_value ){
								$sel_value =  isset($setting_key) ? $setting_key : $setting_value;
								$sel_res = in_array($sel_value, $default_value) ? ' selected="selected"' : '';
								echo '<option value="' . esc_attr( $sel_value ) . '"' . $sel_res . '>' . esc_html( $setting_value ) . '</option>';
					...
					case 'upload':
						echo '<input name="' . esc_attr( $option_slug ) . '" type="text" id="' . esc_attr( $option_slug ) . '" value="" class="regular-text dtthemes_option dtthemes_upload_field" />' . '<a href="#" class="dtthemes_upload_button">' . esc_html__('Upload', 'dt_plugins') . '</a>';
						break;
		...
		echo '<span id="save_columnoptions" class="dt_button save_columnoptions">'.esc_html__('Save Changes', 'dt_plugins').'</span>';
		echo '</form>';
...
if ( ! function_exists('dt_generate_fullwidthsection_options') ){
	function dt_generate_fullwidthsection_options( $dt_section_key ){
		...
		echo '<div class="dt_dialog_handle">' . esc_html__('Fullwidth Section Options', 'dt_plugins') . '</div><a href="#" id="dt_close_sections_settings"></a>';
					...
					switch ( $field_settings['type'] ) {
						...
						case 'select':		
							...
							'<span class="selection-box"><select name="' . esc_attr( $field_key ) . '" id="' . esc_attr( $field_key ) . '" class="dtthemes_fws_option ' . $dt_depand . $content_class . '" '.$multi_str.'>'
								. '<option value="'.$select_default.'">  ' . esc_html__('Select', 'dt_plugins') . '  </option>';
						...
						case 'upload':
							echo '<p><label>'.$field_settings['title'].'</label> ';
							echo '<input name="' . esc_attr( $field_key ) . '" type="text" id="' . esc_attr( $field_key ) . '" value="" class="regular-text dtthemes_fws_option dtthemes_upload_field' . $content_class . '" />' . '<a href="#" class="dtthemes_upload_button">' . esc_html__('Upload', 'dt_plugins') . '</a>';
		...
		echo '<span id="save_fullwidthoptions" class="dt_button save_fullwidthoptions">'.esc_html__('Save Changes', 'dt_plugins').'</span>';
		echo '</form>';
	}
}
...
if ( ! function_exists('dt_generate_modules_panel') ){
	function dt_generate_modules_panel($dt_hide_elements){
		echo '<div class="dt_dialog_handle">' . esc_html__('Add Modules', 'dt_plugins') . '</div><a href="#" id="dt_close_popup_modules"></a>';
		echo '<form id="dt_popup_modules" class="dt_settings_form">';
				echo '<div class="dt_search_modules">';
					echo '<input type="text" name="dt_search_field" id="dt_search_filed" placeholder="'.esc_html('Search Here', 'dt_plugins').'" />';
				echo '</div>';
...
if ( ! function_exists('dt_generate_customcss_options') ){
	function dt_generate_customcss_options( $cssdata ){
		...
		echo '<div class="dt_dialog_handle">' . esc_html__('Add Custom CSS', 'dt_plugins') . '</div><a href="#" id="dt_close_customcss_settings"></a>';
		echo '<form id="dt_customcss_settings">'
			    ...
			    . '<span id="save_customcss" class="dt_button save_customcss">'.esc_html__('Save Changes', 'dt_plugins').'</span>';
		echo '</form>';
	}
}
