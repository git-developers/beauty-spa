...
class spalab_import {
	...
	function import_menu_location( $file = 'menu.txt' ){
		...
		$file_path 	= IAMD_FW_URL.'importer/'. $file;
	...
	function import(){
		...
		if( ! class_exists( 'WP_Import' ) ){
			require_once IAMD_CORE_PLUGIN . '/importer/wordpress-importer.php';
		}
		...
		if( class_exists( 'WP_Importer' ) && class_exists( 'WP_Import' ) ){
			...
			switch( $_REQUEST['data']['import'] ) {
				...
				case 'all':
					...
					#$this->migrate_cb($this->urls[$import_demo]);
...
$dtthemes_import = new spalab_import;
