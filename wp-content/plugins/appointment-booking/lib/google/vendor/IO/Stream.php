...
/**
 * Http Streams based implementation of BooklyGoogle_IO.
 *
...
class BooklyGoogle_IO_Stream extends BooklyGoogle_IO_Abstract
{
  ...
  public function executeRequest(BooklyGoogle_Http_Request $request)
  {
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new BooklyGoogle_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new BooklyGoogle_IO_Exception($error, $respHttpCode);
    }
