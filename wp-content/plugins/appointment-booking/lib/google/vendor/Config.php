...
class BooklyGoogle_Config
{
  ...
  /**
   * Create a new BooklyGoogle_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'BooklyGoogle_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'BooklyGoogle_Cache_File',
      'logger_class'  => 'BooklyGoogle_Logger_Null',
      ...
      'classes' => array(
        'BooklyGoogle_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'BooklyGoogle_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'BooklyGoogle_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'BooklyGoogle_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'BooklyGoogle_Http_Request' => array(
        ...
        'BooklyGoogle_Auth_OAuth2' => array(
        ...
        'BooklyGoogle_Task_Runner' => array(
        ...
        'BooklyGoogle_Service_Exception' => array(
          'retry_map' => array(
        ...
        'BooklyGoogle_IO_Exception' => array(
        ...
        'BooklyGoogle_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/BooklyGoogle_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see BooklyGoogle_Auth_LoginTicket) after sign
