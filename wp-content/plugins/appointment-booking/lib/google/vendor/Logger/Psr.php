 ...
 * with the `BooklyGoogle_Logger_Psr::setLogger()` method.
 */
class BooklyGoogle_Logger_Psr extends BooklyGoogle_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(BooklyGoogle_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
