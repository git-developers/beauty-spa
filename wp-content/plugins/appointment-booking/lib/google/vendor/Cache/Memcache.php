 ...
 */
class BooklyGoogle_Cache_Memcache extends BooklyGoogle_Cache_Abstract
{
   ...
   * @param string $key
   * @param string $value
   * @throws BooklyGoogle_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new BooklyGoogle_Cache_Exception("Couldn't store data in cache");
    }
