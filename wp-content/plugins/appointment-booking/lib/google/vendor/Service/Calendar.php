 ...
 * @author Google, Inc.
 */
class BooklyGoogle_Service_Calendar extends BooklyGoogle_Service
{
   ...
   *
   * @param BooklyGoogle_Client $client
   */
  public function __construct(BooklyGoogle_Client $client)
  {
    ...
    $this->acl = new BooklyGoogle_Service_Calendar_Acl_Resource(
        $this,
        $this->serviceName,
        'acl',
        array(
    ...
    $this->calendarList = new BooklyGoogle_Service_Calendar_CalendarList_Resource(
        $this,
        $this->serviceName,
        'calendarList',
        array(
    ...
    $this->calendars = new BooklyGoogle_Service_Calendar_Calendars_Resource(
        $this,
        $this->serviceName,
        'calendars',
        array(
    ...
    $this->channels = new BooklyGoogle_Service_Calendar_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->colors = new BooklyGoogle_Service_Calendar_Colors_Resource(
        $this,
        $this->serviceName,
        'colors',
        array(
    ...
    $this->events = new BooklyGoogle_Service_Calendar_Events_Resource(
        $this,
        $this->serviceName,
        'events',
        array(
    ...
    $this->freebusy = new BooklyGoogle_Service_Calendar_Freebusy_Resource(
        $this,
        $this->serviceName,
        'freebusy',
        array(
    ...
    $this->settings = new BooklyGoogle_Service_Calendar_Settings_Resource(
        $this,
        $this->serviceName,
        'settings',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $calendarService = new BooklyGoogle_Service_Calendar(...);
 *   $acl = $calendarService->acl;
 *  </code>
 */
class BooklyGoogle_Service_Calendar_Acl_Resource extends BooklyGoogle_Service_Resource
{
   ...
   * @param string $ruleId ACL rule identifier.
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_AclRule
   */
  public function get($calendarId, $ruleId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "BooklyGoogle_Service_Calendar_AclRule");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param BooklyGoogle_AclRule $postBody
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_AclRule
   */
  public function insert($calendarId, BooklyGoogle_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "BooklyGoogle_Service_Calendar_AclRule");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_Acl
   */
  public function listAcl($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "BooklyGoogle_Service_Calendar_Acl");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_AclRule
   */
  public function patch($calendarId, $ruleId, BooklyGoogle_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "BooklyGoogle_Service_Calendar_AclRule");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_AclRule
   */
  public function update($calendarId, $ruleId, BooklyGoogle_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "BooklyGoogle_Service_Calendar_AclRule");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param BooklyGoogle_Channel $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param int maxResults Maximum number of entries returned on one result
   * page. By default the value is 100 entries. The page size can never be larger
   ...
   * without any syncToken. Learn more about incremental synchronization.
   * Optional. The default is to return all entries.
   * @return BooklyGoogle_Service_Calendar_Channel
   */
  public function watch($calendarId, BooklyGoogle_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "BooklyGoogle_Service_Calendar_Channel");
  }
}
 ...
 *  </code>
 */
class BooklyGoogle_Service_Calendar_CalendarList_Resource extends BooklyGoogle_Service_Resource
{
   ...
   * the currently logged in user, use the "primary" keyword.
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_CalendarListEntry
   */
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "BooklyGoogle_Service_Calendar_CalendarListEntry");
  }

  /**
   * Adds an entry to the user's calendar list. (calendarList.insert)
   *
   * @param BooklyGoogle_CalendarListEntry $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return BooklyGoogle_Service_Calendar_CalendarListEntry
   */
  public function insert(BooklyGoogle_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "BooklyGoogle_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_CalendarList
   */
  public function listCalendarList($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "BooklyGoogle_Service_Calendar_CalendarList");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_CalendarListEntry
   */
  public function patch($calendarId, BooklyGoogle_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "BooklyGoogle_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_CalendarListEntry
   */
  public function update($calendarId, BooklyGoogle_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "BooklyGoogle_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_Channel
   */
  public function watch(BooklyGoogle_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "BooklyGoogle_Service_Calendar_Channel");
 ...
 *  </code>
 */
class BooklyGoogle_Service_Calendar_Calendars_Resource extends BooklyGoogle_Service_Resource
{
   ...
   * the currently logged in user, use the "primary" keyword.
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_Calendar
   */
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "BooklyGoogle_Service_Calendar_Calendar");
  }

  /**
   * Creates a secondary calendar. (calendars.insert)
   *
   * @param BooklyGoogle_Calendar $postBody
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_Calendar
   */
  public function insert(BooklyGoogle_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "BooklyGoogle_Service_Calendar_Calendar");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_Calendar
   */
  public function patch($calendarId, BooklyGoogle_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "BooklyGoogle_Service_Calendar_Calendar");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_Calendar
   */
  public function update($calendarId, BooklyGoogle_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "BooklyGoogle_Service_Calendar_Calendar");
  }
}
 ...
 *  </code>
 */
class BooklyGoogle_Service_Calendar_Channels_Resource extends BooklyGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(BooklyGoogle_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class BooklyGoogle_Service_Calendar_Colors_Resource extends BooklyGoogle_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_Colors
   */
  public function get($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "BooklyGoogle_Service_Calendar_Colors");
  }
}
 ...
 *  </code>
 */
class BooklyGoogle_Service_Calendar_Events_Resource extends BooklyGoogle_Service_Resource
{
  ...
  public function get($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "BooklyGoogle_Service_Calendar_Event");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param BooklyGoogle_Event $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return BooklyGoogle_Service_Calendar_Event
   */
  public function import($calendarId, BooklyGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('import', array($params), "BooklyGoogle_Service_Calendar_Event");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_Event
   */
  public function insert($calendarId, BooklyGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "BooklyGoogle_Service_Calendar_Event");
  }
   ...
   * @opt_param string timeZone Time zone used in the response. Optional. The
   * default is the time zone of the calendar.
   * @return BooklyGoogle_Service_Calendar_Events
   */
  public function instances($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('instances', array($params), "BooklyGoogle_Service_Calendar_Events");
  }
  ...
  public function listEvents($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "BooklyGoogle_Service_Calendar_Events");
  }
  ...
  public function move($calendarId, $eventId, $destination, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "BooklyGoogle_Service_Calendar_Event");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_Event
   */
  public function patch($calendarId, $eventId, BooklyGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "BooklyGoogle_Service_Calendar_Event");
  }
  ...
  public function quickAdd($calendarId, $text, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('quickAdd', array($params), "BooklyGoogle_Service_Calendar_Event");
  }
   ...
   * @return BooklyGoogle_Service_Calendar_Event
   */
  public function update($calendarId, $eventId, BooklyGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "BooklyGoogle_Service_Calendar_Event");
  }
 ...
 *  </code>
 */
class BooklyGoogle_Service_Calendar_Freebusy_Resource extends BooklyGoogle_Service_Resource
{

  /**
   * Returns free/busy information for a set of calendars. (freebusy.query)
   *
   * @param BooklyGoogle_FreeBusyRequest $postBody
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_FreeBusyResponse
   */
  public function query(BooklyGoogle_Service_Calendar_FreeBusyRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "BooklyGoogle_Service_Calendar_FreeBusyResponse");
  }
}
 ...
 *  </code>
 */
class BooklyGoogle_Service_Calendar_Settings_Resource extends BooklyGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return BooklyGoogle_Service_Calendar_Setting
   */
  public function get($setting, $optParams = array())
  {
    $params = array('setting' => $setting);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "BooklyGoogle_Service_Calendar_Setting");
  }
   ...
   * synchronization. Optional. The default is to return all entries.
   * @return BooklyGoogle_Service_Calendar_Settings
   */
  public function listSettings($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "BooklyGoogle_Service_Calendar_Settings");
  }
...
class BooklyGoogle_Service_Calendar_Acl extends BooklyGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'BooklyGoogle_Service_Calendar_AclRule';
...
class BooklyGoogle_Service_Calendar_AclRule extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  ...
  public $kind;
  public $role;
  protected $scopeType = 'BooklyGoogle_Service_Calendar_AclRuleScope';
  ...
  public function setScope(BooklyGoogle_Service_Calendar_AclRuleScope $scope)
  {
    $this->scope = $scope;
  }
...
class BooklyGoogle_Service_Calendar_AclRuleScope extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class BooklyGoogle_Service_Calendar_Calendar extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class BooklyGoogle_Service_Calendar_CalendarList extends BooklyGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'BooklyGoogle_Service_Calendar_CalendarListEntry';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class BooklyGoogle_Service_Calendar_CalendarListEntry extends BooklyGoogle_Collection
{
  ...
  public $colorId;
  protected $defaultRemindersType = 'BooklyGoogle_Service_Calendar_EventReminder';
  ...
  public $kind;
  public $location;
  protected $notificationSettingsType = 'BooklyGoogle_Service_Calendar_CalendarListEntryNotificationSettings';
  ...
  public function setNotificationSettings(BooklyGoogle_Service_Calendar_CalendarListEntryNotificationSettings $notificationSettings)
  {
...
class BooklyGoogle_Service_Calendar_CalendarListEntryNotificationSettings extends BooklyGoogle_Collection
{
  protected $collection_key = 'notifications';
  protected $internal_gapi_mappings = array(
  );
  protected $notificationsType = 'BooklyGoogle_Service_Calendar_CalendarNotification';
...
class BooklyGoogle_Service_Calendar_CalendarNotification extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class BooklyGoogle_Service_Calendar_Channel extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class BooklyGoogle_Service_Calendar_ColorDefinition extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $background;
...
class BooklyGoogle_Service_Calendar_Colors extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarType = 'BooklyGoogle_Service_Calendar_ColorDefinition';
  protected $calendarDataType = 'map';
  protected $eventType = 'BooklyGoogle_Service_Calendar_ColorDefinition';
...
class BooklyGoogle_Service_Calendar_Error extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $domain;
...
class BooklyGoogle_Service_Calendar_Event extends BooklyGoogle_Collection
{
  protected $collection_key = 'recurrence';
  protected $internal_gapi_mappings = array(
  );
  public $anyoneCanAddSelf;
  protected $attachmentsType = 'BooklyGoogle_Service_Calendar_EventAttachment';
  protected $attachmentsDataType = 'array';
  protected $attendeesType = 'BooklyGoogle_Service_Calendar_EventAttendee';
  protected $attendeesDataType = 'array';
  public $attendeesOmitted;
  public $colorId;
  public $created;
  protected $creatorType = 'BooklyGoogle_Service_Calendar_EventCreator';
  protected $creatorDataType = '';
  public $description;
  protected $endType = 'BooklyGoogle_Service_Calendar_EventDateTime';
  protected $endDataType = '';
  public $endTimeUnspecified;
  public $etag;
  protected $extendedPropertiesType = 'BooklyGoogle_Service_Calendar_EventExtendedProperties';
  protected $extendedPropertiesDataType = '';
  protected $gadgetType = 'BooklyGoogle_Service_Calendar_EventGadget';
  ...
  public $location;
  public $locked;
  protected $organizerType = 'BooklyGoogle_Service_Calendar_EventOrganizer';
  protected $organizerDataType = '';
  protected $originalStartTimeType = 'BooklyGoogle_Service_Calendar_EventDateTime';
  protected $originalStartTimeDataType = '';
  public $privateCopy;
  public $recurrence;
  public $recurringEventId;
  protected $remindersType = 'BooklyGoogle_Service_Calendar_EventReminders';
  protected $remindersDataType = '';
  public $sequence;
  protected $sourceType = 'BooklyGoogle_Service_Calendar_EventSource';
  protected $sourceDataType = '';
  protected $startType = 'BooklyGoogle_Service_Calendar_EventDateTime';
  ...
  public function setCreator(BooklyGoogle_Service_Calendar_EventCreator $creator)
  {
  ...
  public function setEnd(BooklyGoogle_Service_Calendar_EventDateTime $end)
  {
    $this->end = $end;
  }
  ...
  public function setExtendedProperties(BooklyGoogle_Service_Calendar_EventExtendedProperties $extendedProperties)
  {
  ...
  public function setGadget(BooklyGoogle_Service_Calendar_EventGadget $gadget)
  {
    $this->gadget = $gadget;
  }
  ...
  public function setOrganizer(BooklyGoogle_Service_Calendar_EventOrganizer $organizer)
  {
  ...
  public function setOriginalStartTime(BooklyGoogle_Service_Calendar_EventDateTime $originalStartTime)
  {
  ...
  public function setReminders(BooklyGoogle_Service_Calendar_EventReminders $reminders)
  {
  ...
  public function setSource(BooklyGoogle_Service_Calendar_EventSource $source)
  {
    $this->source = $source;
  }
  ...
  public function setStart(BooklyGoogle_Service_Calendar_EventDateTime $start)
  {
    $this->start = $start;
  }
...
class BooklyGoogle_Service_Calendar_EventAttachment extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fileId;
...
class BooklyGoogle_Service_Calendar_EventAttendee extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class BooklyGoogle_Service_Calendar_EventCreator extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class BooklyGoogle_Service_Calendar_EventDateTime extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $date;
...
class BooklyGoogle_Service_Calendar_EventExtendedProperties extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $private;
...
class BooklyGoogle_Service_Calendar_EventGadget extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $display;
...
class BooklyGoogle_Service_Calendar_EventOrganizer extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class BooklyGoogle_Service_Calendar_EventReminder extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class BooklyGoogle_Service_Calendar_EventReminders extends BooklyGoogle_Collection
{
  protected $collection_key = 'overrides';
  protected $internal_gapi_mappings = array(
  );
  protected $overridesType = 'BooklyGoogle_Service_Calendar_EventReminder';
...
class BooklyGoogle_Service_Calendar_EventSource extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $title;
...
class BooklyGoogle_Service_Calendar_Events extends BooklyGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $description;
  public $etag;
  protected $itemsType = 'BooklyGoogle_Service_Calendar_Event';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class BooklyGoogle_Service_Calendar_FreeBusyCalendar extends BooklyGoogle_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $busyType = 'BooklyGoogle_Service_Calendar_TimePeriod';
  protected $busyDataType = 'array';
  protected $errorsType = 'BooklyGoogle_Service_Calendar_Error';
...
class BooklyGoogle_Service_Calendar_FreeBusyGroup extends BooklyGoogle_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
...
class BooklyGoogle_Service_Calendar_FreeBusyRequest extends BooklyGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $itemsType = 'BooklyGoogle_Service_Calendar_FreeBusyRequestItem';
  protected $itemsDataType = 'array';
  public $timeMax;
  public $timeMin;
  public $timeZone;
...
class BooklyGoogle_Service_Calendar_FreeBusyRequestItem extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class BooklyGoogle_Service_Calendar_FreeBusyResponse extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarsType = 'BooklyGoogle_Service_Calendar_FreeBusyCalendar';
  protected $calendarsDataType = 'map';
  protected $groupsType = 'BooklyGoogle_Service_Calendar_FreeBusyGroup';
...
class BooklyGoogle_Service_Calendar_Setting extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class BooklyGoogle_Service_Calendar_Settings extends BooklyGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'BooklyGoogle_Service_Calendar_Setting';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class BooklyGoogle_Service_Calendar_TimePeriod extends BooklyGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $end;
