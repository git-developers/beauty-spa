jQuery(function($) {
    ...
    $cf_per_service
        ...
        .change(function() {
            $('.bookly-services-holder').toggle(this.value == '1');
        });
    ...
    function updateServiceButton($holder) {
        ...
        if (service_checked == 0) {
            $holder.find('.bookly-js-count').text(BooklyCustomFieldsL10n.selector.nothing_selected);
            ...
            if( service_checked == $holder.find('.bookly-js-check-entity').length) {
                ...
                $holder.find('.bookly-js-count').text(BooklyCustomFieldsL10n.selector.all_selected);
            } else {
                $holder.find('.bookly-check-all-entities').prop('checked', false);
