...
class Local extends Proxy\Coupons
{
     ...
     * @inheritdoc
     */
    public static function getPaymentStepHtml( BooklyLib\UserBookingData $userData )
    {
        ...
        return self::renderTemplate( 'coupon_block', compact( 'info_text_coupon', 'coupon_code' ), false );
    }
}