...
abstract class CodeGenerator
{
     ...
     * @throws \Exception
     */
    public static function generateUniqueCode( $mask )
    {
        $existing_codes = static::_getExistingCodes( $mask );
     ...
     * @throws \Exception
     */
    public static function generateUniqueCodeSeries( $mask, $amount )
    {
        $existing_codes = static::_getExistingCodes( $mask );
     ...
     * @return array
     */
    private static function _getExistingCodes( $mask )
    {
        return Entities\Coupon::query()
