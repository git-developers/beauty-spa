...
class Installer extends BooklyLib\Base\Installer
{
    public function __construct()
    {
        ...
        $this->options = array(
            ...
            'bookly_l10n_info_coupon_single_app'   => __( 'The total price for the booking is {total_price}.', 'bookly-coupons' ),
            'bookly_l10n_info_coupon_several_apps' => __( 'You selected to book {appointments_count} appointments with total price {total_price}.', 'bookly-coupons' ),
            'bookly_l10n_label_coupon'             => __( 'Coupon', 'bookly-coupons' ),
