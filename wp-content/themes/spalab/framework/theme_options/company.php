	...
	<div class="bpanel-main-content">
            ...
            <div class="bpanel-box"><?php
                if( dttheme_is_plugin_active('designthemes-core-features/designthemes-core-features.php') ) : ?>
                    ...
                    <div class="box-content">
                        ...
                        <div class="clear"> </div>
                        <div class="hr-invisible-small"> </div>
                        <h6><?php _e('Business Account Username','dt_themes');?></h6>
                        <input name="mytheme[company][api-username]" type="text" class="large" value="<?php echo dttheme_option('company','api-username');?>"/>
                        <p class="note"><?php esc_html_e('Enter a valid Merchant account ID or PayPal account email address. All payments will go to this account.', 'dt_themes');?></p>
        ...
        <div id="my-notifications" class="tab-content">
            ...
            if( dttheme_is_plugin_active('designthemes-core-features/designthemes-core-features.php') ) :
            	...
            	<div class="box-title"><h3><?php _e('To Admin','dt_themes');?></h3></div>
                <div class="box-content">
              
                   <h6><b><?php _e('Notification to the admin about new Appointment', 'dt_themes');?></b></h6>
                   ...
                   <h6><b><?php _e('Notification to the admin regarding modified Appointment', 'dt_themes');?></b></h6>
                   <h5><?php _e('Subject','dt_themes');?></h5>
                   ...
                   <h6><b><?php _e('Notification to the admin regarding Deleted / Declined Appointment', 'dt_themes');?></b></h6>
                   <h5><?php _e('Subject','dt_themes');?></h5>
