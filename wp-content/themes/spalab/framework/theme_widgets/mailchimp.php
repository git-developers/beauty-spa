...
class MY_Mailchimp extends WP_Widget {
	...
	function __construct() {
		$widget_options = array("classname"=>'mailchimp', 'description'=>__('Use this widget to add a mailchimp newsletter to your site.', 'dt_themes'));
...
<?php   else:
	...
	function widget($args, $instance) {
		...
		echo '<p>'.__('Subscribe to your newsletter for latest offers and discounts. We will not spam you.', 'dt_themes').'</p>';

		echo '<form name="frmsubscribe" method="post" class="subscribe-frm">';
		echo '<input type="email" required name="dt_mc_emailid" id="dt_mc_emailid" placeholder="'.__('Enter Email', 'dt_themes').'" />';
		...
		echo '<input type="submit" name="submit" class="dt-sc-button small" value="'.__('Subscribe', 'dt_themes').'" />';
		echo '</form>';
