                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-entry'); ?>>
                        ...
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-meta">
                            	<a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('%s','dt_themes'),the_title_attribute('echo=0'));?>" class="entry_format"> </a>
                            ...
                            <div class="entry-thumb">
								<?php $format = get_post_format(  get_the_id() );
                                    ...
                                    <?php if( $format === "image" || empty($format) ): ?>
                                        <a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('%s','dt_themes'),the_title_attribute('echo=0'));?>">
                                        <?php if( has_post_thumbnail() ):
                                                the_post_thumbnail("full");
                                              else:
												if($enable_placeholder){ ?>
                                                  <img src="http<?php dt_ssl();?>://placehold.it/1060x636&text=Image" alt="<?php printf(esc_attr__('%s','dt_themes'),the_title_attribute('echo=0'));?>" title="<?php printf(esc_attr__('%s','dt_themes'),the_title_attribute('echo=0'));?>" />
                                        <?php   } endif;?>
                                        </a>
                                <?php elseif( $format === "gallery" ):
                                      ...
                                      elseif( $format === "audio" ):
                                        ...
                                        <a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('%s','dt_themes'),the_title_attribute('echo=0'));?>"><?php
                            ...
                            <div class="entry-details">
                                ...
                                <div class="entry-title">
                                	<h4><a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('%s','dt_themes'),the_title_attribute('echo=0'));?>"><?php the_title();?></a></h4>
                                </div><!-- .entry-title -->
                                ...
                                <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('%s','dt_themes'), the_title_attribute('echo=0'));?>" class="dt-sc-button small read-more">
