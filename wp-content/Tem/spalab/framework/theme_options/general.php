            ...
            <div class="bpanel-box">
                    ...
                    <div class="box-content">
                     ...
                     <h6> <?php _e('Disable Loading Bar','dt_themes'); ?></h6>
                      ...
                      <label><?php _e('Breadcrumb Type','dt_themes');?></label>
                      <select id="mytheme-breadcrumb-type" name="mytheme[general][breadcrumb-type]"><?php 
					  	$breadcrumb_types = array('type1','type2');
							...
							endforeach;?></select>
                      <p class="note"><?php _e('Select breadcrumb type','dt_themes');?></p>
                      
                      <h6><?php _e('Default Breadcrumb Image','dt_themes');?></h6>
                        <div class="image-preview-container">
                        ...
                        <p class="note"> <?php _e('Upload a default breadcrumb image for your theme. This option is applicable for breadcrumb TYPE2','dt_themes');?> </p>
                      ...
                      <div class="column one-half last">
                       ...
                       <?php  
						if(dttheme_option('general','mailchimp-key') != '') { 
							...
							<h6><?php esc_html_e('Mailchimp List Id','dt_themes');?></h6>
							<?php
							...
							?>
							<p class="note no-margin"><?php esc_html_e('Select your mailchip list id, which will be used in newsletter shortcodes.','dt_themes'); ?></p>
