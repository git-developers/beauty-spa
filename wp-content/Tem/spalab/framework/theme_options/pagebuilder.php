            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
						...
						<h6><?php esc_html_e('Choose any of these post types to activate page builder', 'dt_themes');?></h6><?php
						//Getting post types...
						$post_types = array( 'post' => 'Post', 'page' => 'Page', 'dt_portfolios' => 'Portfolios', 'dt_catalog' => 'Catalog' );
                    ...
                    <div class="bpanel-option-set">
                         ...
                         <?php
						if(dttheme_option('pagebuilder_update') == 'done') { $disable_cls = 'disabled'; }
						else { $disable_cls = ''; }
						?>
                        <h6><?php esc_html_e('Update page contents for latest page builder', 'dt_themes'); ?></h6>
                        <input type="button" value="<?php esc_attr_e('Update Content','dt_themes');?>" class="dt_update_pagebuilder_contents <?php echo $disable_cls; ?>" />
						<p class="note"><?php esc_html_e('Latest page builder update needs your content to be updated. Please click the above button to update it. It may take while please be patient.','dt_themes');?></p>
                        <div class="hr"></div>
