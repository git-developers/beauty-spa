...
<div id="specialty-pages" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
    	 <ul class="sub-panel">
         <?php $sub_menus = array(
					array("title"=>__("Global",'dt_themes'), "link"=>"#global-page"),
         ...
         <?php $posts_layout_array =   array( 'one-column'=>__("Single post per row.",'dt_themes'),'one-half-column'=>__("Two posts per row.",'dt_themes'));
                ...
                $tabs = array(
                        ...
                        array(  "id"=>"global-layout",
								"layout-title"=>__("Global Layout",'dt_themes'),
								"layout-tooltip"=>__("You can choose between a left, right or no sidebar layout globally.",'dt_themes')
						 ),
                    ...
                    <div class="box-content">
                    	...
                    	<?php if($id == 'global-layout'): ?>
                                <div class="bpanel-option-set">
                                    ...
                                    <p class="note"> <?php _e('Force to enable or disable global page layout for all pages.','dt_themes');?>  </p>
                                </div>
                                <div class="clear"> </div>
                                <div class="hr"> </div>
                       <?php  endif; ?>
