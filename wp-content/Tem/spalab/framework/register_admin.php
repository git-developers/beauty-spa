...
function dttheme_admin_panel_scripts() {
	...
	wp_localize_script('dttheme', 'objectL10n', array(
		...
		'pageBuilderUpdate' => __('You page and post contents are updated successfully for page builder latest version!', 'dt_themes'),
		'pageBuilderUpdateAlready' => __('Page builder updates are implemented already to your page and post contents!', 'dt_themes')));
}
