...
function dt_currencies() {
	return array_unique( array(
		'AUD' => __('Australian Dollar','dt_themes').' - '.'AUD',
		'BRL' => __('Brazilian Real ','dt_themes').' - '.'BRL',
		'CAD' => __('Canadian Dollar','dt_themes').' - '.'CAD',
		'CZK' => __('Czech Koruna','dt_themes').' - '.'CZK',
		'DKK' => __('Danish Krone','dt_themes').' - '.'DKK',
		'EUR' => __('Euro','dt_themes').' - '.'EUR',
		'HKD' => __('Hong Kong Dollar','dt_themes').' - '.'HKD',
		'HUF' => __('Hungarian Forint','dt_themes').' - '.'HUF',
		'ILS' => __('Israeli New Sheqel','dt_themes').' - '.'ILS',
		'JPY' => __('Japanese Yen','dt_themes').' - '.'JPY',
		'MYR' => __('Malaysian Ringgit','dt_themes').' - '.'MYR',
		'MXN' => __('Mexican Peso','dt_themes').' - '.'MXN',
		'NOK' => __('Norwegian Krone','dt_themes').' - '.'NOK',
		'NZD' => __('New Zealand Dollar','dt_themes').' - '.'NZD',
		'PHP' => __('Philippine Peso','dt_themes').' - '.'PHP',
		'PLN' => __('Polish Zloty','dt_themes').' - '.'PLN',
		'GBP' => __('Pound Sterling','dt_themes').' - '.'GBP',
		'RUB' => __('Russian Ruble','dt_themes').' - '.'RUB',
		'SGD' => __('Singapore Dollar','dt_themes').' - '.'SGD',
		'SEK' => __('Swedish Krona','dt_themes').' - '.'SEK',
		'CHF' => __('Swiss Franc','dt_themes').' - '.'CHF',
		'TWD' => __('Taiwan New Dollar','dt_themes').' - '.'TWD',
		'THB' => __('Thai Baht','dt_themes').' - '.'THB',
		'TRY' => __('Turkish Lira','dt_themes').' - '.'TRY',
		'USD' => __('U.S. Dollar','dt_themes').' - '.'USD'
	) );
}
...
function durationToString( $duration ) {
    ...
    $result  = '';
    if ( $hours > 0 ) {
        $result = sprintf( __( '%d h', 'dt_themes' ), $hours );
        if ( $minutes > 0 ) {
            $result .= ' ';
        }
    }
    ...
    if ( $minutes > 0 ) {
        $result .= sprintf( __( '%d min', 'dt_themes' ), $minutes );
    }
 return $result;
}
